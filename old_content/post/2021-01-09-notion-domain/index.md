...
title: "[Notion] 노션 페이지와 도메인 연결하기" #[카테고리] 제목은 간결하게
subtitle: "클라우드플래어(cloudflare)의 서버리스 컴퓨팅 서비스인 Workers를 이용하여 
notion의 공개 페이지와 도메인을 연결해 보자." #부제는 결과를 간략하게
summary: "클라우드플래어(cloudflare)의 서버리스 컴퓨팅 서비스인 Workers를 이용하여 
notion의 공개 페이지와 도메인을 연결해 보자." #섬머리는 포스트 리스트에 표시되며, 구글 검색에서도 표시됨.
authors: []
tags: [] #태그는 이왕이면 소문자 영어로
categories: [] #카테고리는 필수적으로 소문자 영어로
date: 2021-01-07T15:54:29+09:00
lastmod: 2021-01-07T15:54:29+09:00
featured: false
draft: true
