...
title: "[Hugo] 1분만에 휴고 블로그를 만들어 보자 (Create a Hugo blog in just 1 minute)" #[카테고리] 제목은 간결하게
subtitle: "누구나 버튼 한번에 Github에 휴고 블로그를 만들수 있다" #부제는 결과를 간략하게
summary: "1분만에 누구나 접속 가능한 휴고(Hugo) 블로그를 만들 수 있다." #섬머리는 포스트 리스트에 표시되며, 구글 검색에서도 표시됨.
authors: []
tags: [] #태그는 이왕이면 소문자 영어로
categories: [] #카테고리는 필수적으로 소문자 영어로
date: 2021-01-07T16:41:47+09:00
lastmod: 2021-01-07T16:41:47+09:00
featured: false
draft: true
