...
title: "[파이썬] 공공데이터 포털에서 코로나19 확진자수 구하기 (+colab 코드 포함)" #[카테고리] 제목은 간결하게
subtitle: "코로나19 확진자수를 공공데이터 Open API로 받아오자" #부제는 결과를 간략하게
summary: "" #섬머리는 포스트 리스트에 표시되며, 구글 검색에서도 표시됨.
authors: []
tags: [python, openapi, covid19] #태그는 이왕이면 소문자 영어로
categories: [python] #카테고리는 필수적으로 소문자 영어로
date: 2021-01-03T23:38:43+09:00
lastmod: 2021-01-03T23:38:43+09:00
featured: false
draft: false
