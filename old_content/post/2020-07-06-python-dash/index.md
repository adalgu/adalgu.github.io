...
title: "[파이썬] Python Dash로 결정했다 (vs. R Shiny, Bokeh)" #[카테고리] 제목은 간결하게
subtitle: "웹 대시보드를 만들어 보자" #부제는 결과를 간략하게
summary: ""
authors: []
tags: [dash, 대시보드] #태그는 이왕이면 소문자 영어로
categories: [python] #카테고리는 필수적으로 소문자 영어로
date: 2020-07-08T09:36:44+09:00
lastmod: 2020-07-08T09:36:44+09:00
featured: false
draft: false
