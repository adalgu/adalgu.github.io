...
title: "[파이썬/colab] 공공데이터 Open API를 이용한 지하철 승차인원 구하기 예제코드" #[카테고리] 제목은 간결하게
subtitle: "코랩과 구글 드라이브를 이용하여 공공데이터를 쉽게 받아보자" #부제는 결과를 간략하게
summary: ""
authors: []
tags: [python, openapi, pandas, colab] #태그는 이왕이면 소문자 영어로
categories: [python] #카테고리는 필수적으로 소문자 영어로
date: 2020-11-04T16:57:43+09:00
lastmod: 2020-11-04T16:57:43+09:00
featured: false
draft: false
